...
class NRPR_DinoSigLIPViTBackbone(VisionBackbone):
    ...
    def forward(
        ...
        if pixel_values is not None and image_hidden_states is not None:
            ...
            print("patch_attention_mask = ", patch_attention_mask.shape)
            print("attention_mask = ", patch_attention_mask.view(pixel_values.size(0), -1).shape)
            print("sig_image_hidden_states = ", sig_image_hidden_states.shape)
