...
class CROP_PR_DinoSigLIPImageTransform:
    ...
    def crop_image_transform(self, image_tensor):
        ...
        print("small_image_tensor = ", small_image_tensor.shape)
...
class CROP_PR_DinoSigLIP_V3_ViTBackbone(VisionBackbone):
    def __init__(self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 384) -> None:
        ...
        self.sig_vision_model = SiglipVisionModel.from_pretrained("/mnt/nas/share/home/qbc/ckpt/siglip-384")
        self.dino_vision_model = Dinov2Model.from_pretrained("/mnt/nas/share/home/qbc/ckpt/dinov2-large")  # Initialize DinoViT model as well
    ...
    def forward(
        ...
        if pixel_values is not None and image_hidden_states is not None:
            ...
            pixel_values = rearrange(pixel_values, '1 (n c) h w -> n c h w', c=3)
