...
torchrun --standalone --nnodes 1 --nproc-per-node 8 /mnt/csp/mmvision/home/lwh/openvla/scripts/pretrain.py \
  ...
  --pretrained_checkpoint "/mnt/csp/mmvision/home/lwh/openvla_runs/llava_more+jetmoe-dinosiglip-224px+stage-finetune+x7/checkpoints/step-006782-epoch-00-loss=1.1605.pt" \
